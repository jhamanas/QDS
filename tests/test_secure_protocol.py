...
bad = SecureSignature(sig.session_id, sig.signature_id, "alice", "bob", 0, sig.payload_digest, tuple(forged.disclosed_descriptions), sig.opening_nonces); assert not verifier.verify(bad, "pay:10", rng).accepted
...
missing_openings = SecureSignature(sig.session_id, sig.signature_id, "alice", "bob", 0,
...
bad_opening = SecureSignature(sig.session_id, sig.signature_id, "alice", "bob", 0,
                              sig.payload_digest, sig.disclosed_descriptions,
